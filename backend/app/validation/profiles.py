...
CI_BLOCKING_CODES: Set[str] = {
    ...
    codes.TRN_LOCALITY_WITHOUT_PROVENANCE,
    codes.TRN_LOCALITY_INVALID_STATE,
    codes.TRN_LOCALITY_EXACT_PIN_WITHOUT_COORDINATE,
    codes.TRN_FIRST_MILE_ON_LOCALITY_ONLY,
    codes.TRN_BIGDATACLOUD_WITHOUT_INPUT_COORDINATE,
}