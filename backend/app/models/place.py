...
class Place(Base):
    ...
    __table_args__ = (
        ...
        Index("ix_places_highway_corridor", "highway_corridor"),
        Index("ix_places_food_category", "food_category"),
    )
    ...
    # Food extension fields (Phase 3A additive schema)
    cuisine = Column(String, nullable=True)
    dietary_tags = Column(JSON, nullable=True)
    speciality_dishes = Column(JSON, nullable=True)
