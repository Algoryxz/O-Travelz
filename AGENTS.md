...
3. Read [`docs/archive/ROUND2_TEAM.md`](docs/archive/ROUND2_TEAM.md) if referencing historical Round 2 regional research ownership.
...
10. If working on regional research, read `docs/archive/ROUND2_TEAM.md`, the relevant regional README in `data/research/round2/`, and the schemas before staging records.
