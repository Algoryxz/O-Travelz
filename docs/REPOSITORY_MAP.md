...
| `backend/app/api/` | API routers and HTTP wiring | Rudra with Smarak AI boundary | 4–7 | `itinerary_routes.py`, transport routing, and accepted `ai_routes.py` orchestration boundary | Ranking or AI internals embedded in routers | Backend service contracts |
