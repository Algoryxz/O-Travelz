...
transport budget must be converted into structured constraints and passed back through
ranking, itinerary, and transport services. The AI must not directly rewrite itinerary
facts or route details.
