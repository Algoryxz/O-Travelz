...
/**
 * Structural container for Discover root.
 * Owns its M3 TopAppBar and responsive layout boundary.
 * Strictly free of premature feature state or mock items.
 */
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = {
                    Text(
                        text = stringResource(NavDestination.DISCOVER.titleRes),
        ...
        Box(
            ...
            Column(
                ...
                Text(
                    text = "Explore Odisha Cultural Atlas",
                ...
                Text(
                    text = stringResource(R.string.root_discover_desc),
