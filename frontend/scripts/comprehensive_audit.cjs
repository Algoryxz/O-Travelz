...
if (fs.existsSync(placesPath)) {
  ...
  const altPath = path.join(__dirname, '../../backend/app/data/places.json');
...
console.log(`   - Schedule Capability: Strict "Scheduled Departure" badge (Never claiming "Live Vehicle Tracking" without active GPS feed)`);
