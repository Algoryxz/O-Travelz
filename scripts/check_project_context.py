...
REQUIRED_FILES: list[tuple[str, str]] = [
    ...
    ("docs/ARCHITECTURE.md", "System architecture & boundaries"),
    ("docs/DATA_MODEL.md", "Canonical data model & source of truth"),
    ("docs/AI.md", "AI copilot & grounding architecture"),
    ("docs/MOBILE.md", "Mobile app architecture & preconditions"),
    ("docs/CONTRIBUTING.md", "Contributing & operating rules"),
    ("docs/DEMO.md", "Demo runbook & fallback procedures"),
